...
void verificarBlocos(int ligacoes[][100], float matrixValores[][100], float velocidades[2])
{
    ...
    while (i < rc + 1)
    {
        if (ligacoes[46][i] == 1)
        {
            ...
            if ((entradaElseA == true) && (entradaElseB == true) && (entradaElseC == true))
            {
                blocoElse = true;
            }
        }
    ...
    while (i < rc + 1)
    {
        if (ligacoes[64][i] == 1 || ligacoes[65][i] == 1)
        {
            if ((entradaTrans1 = true) && (entradaTrans2 = true))
            {
                blocoTrans = true;
            }
        }
    ...
    while (i < rc + 1)
    {
        if (ligacoes[91][i] == 1 || ligacoes[92][i] == 1)
        {
            if (entradaEx1 = true)
            {
                blocoEx = true;
    ...
    while ((blocoInv1 == true) || (blocoInv2 == true) || (blocoSoma1 == true) || (blocoSoma2 == true) || (blocoTemp1 == true) || (blocoDecisor1 == true) || (blocoDecisor2 == true) || (blocoTemp2 == true) || (blocoProduto == true) || (blocoIf == true) || (blocoElse == true) || (blocoAnd == true) || (blocoOr == true) || (blocoMaior == true) || (blocoMenor == true) || (blocoIgual == true) || (blocoTrans == true) || (blocoEx == true))
    {
        ...
        if (blocoInv1 == true)
        {
            ...
            // caso em que vem da saida1 do trans
            if (ligacoes[6][64] == 1)
            {
                // Esta pronto
                if (blocoTrans == false)
                {
                    ...
                    while (j < rc + 1)
                    {
                        if (ligacoes[7][j] == 1)
                        {
                            matrixValores[7][j] = -matrixValores[64][i];
                            matrixValores[j][7] = -matrixValores[64][i];
                        }
                        j = j + 1;
                    }
                    blocoInv2 = false;
            ...
            // caso em que vem da saida2 do trans
            if (ligacoes[6][65] == 1)
            {
                // Esta pronto
                if (blocoTrans == false)
                {
                    ...
                    while (j < rc + 1)
                    {
                        if (ligacoes[7][j] == 1)
                        {
                            matrixValores[7][j] = -matrixValores[65][i];
                            matrixValores[j][7] = -matrixValores[65][i];
                        }
                        j = j + 1;
                    }
                    blocoInv2 = false;
            ...
            // caso em que vem da saida2 do trans
            if (ligacoes[6][91] == 1 || ligacoes[6][92] == 1)
            {
                // Esta pronto
                if (blocoEx == false)
                {
        ...
        if (blocoInv2 == true)
        {
            ...
            if (ligacoes[15][64] == 1)
            {
                ...
                if (blocoTrans == false)
                {
                    ...
                    while (j < rc + 1)
                    {
                        if (ligacoes[16][j] == 1)
                        {
                            matrixValores[16][j] = -matrixValores[64][i];
                            matrixValores[j][16] = -matrixValores[64][i];
                        }
                        j = j + 1;
                    }
                    blocoInv2 = false;
            ...
            if (ligacoes[15][65] == 1)
            {
                ...
                if (blocoTrans == false)
                {
                    ...
                    while (j < rc + 1)
                    {
                        if (ligacoes[16][j] == 1)
                        {
                            matrixValores[16][j] = -matrixValores[65][i];
                            matrixValores[j][16] = -matrixValores[65][i];
                        }
                        j = j + 1;
                    }
                    blocoInv2 = false;
            ...
            // caso em que vem da saida2 do trans
            if (ligacoes[15][91] == 1 || ligacoes[15][92] == 1)
            {
                // Esta pronto
                if (blocoEx == false)
                {
        ...
        if (entradaProd1 == true)
        {
            ...
            // caso em que vem da saida do extensor
            if (ligacoes[20][91] == 1)
            {
                // Esta pronto
                if (blocoEx == false)
        ...
        if (blocoElse == true)
        {
            if (blocoIf == false)
            {
                if ((entradaElseA == false) && (entradaElseB == false) && (entradaElseC == false)) // entradas todas prontas
                {
                                ...
                                if (ligacoes[j][43] == 1)
                                {
                                    ...
                                    while (aux < rc + 1)
                                    {
                                        if (ligacoes[aux][46] == 1)
                                        {
                                            while (k > rc + 1)
                                            {
                                                if (ligacoes[k][39] == 0) // verifica se condição do if é falsa
                                                {
                                                    if (matrixValores[j][43] == 1)
                                                    {
        ...
        //----------------------------------------------------------------------
        // entrada trans2
        if (entradaTrans2 == true)
        {

            // Caigualso facil em que e um input imediato
            if ((ligacoes[1][63] == 1) || (ligacoes[2][63] == 1) ||
                (ligacoes[3][63] == 1) || (ligacoes[4][63] == 1) ||
                (ligacoes[5][63] == 1) || (ligacoes[14][63] == 1) ||
                (ligacoes[25][63] == 1) || (ligacoes[30][63] == 1) ||
                (ligacoes[35][63] == 1) || (ligacoes[36][63] == 1) ||
                (ligacoes[37][63] == 1) ||
                (ligacoes[66][63] == 1) || (ligacoes[67][63] == 1) ||
                (ligacoes[68][63] == 1) || (ligacoes[69][63] == 1) ||
                (ligacoes[70][63] == 1) || (ligacoes[71][63] == 1) ||
                (ligacoes[72][63] == 1) || (ligacoes[73][63] == 1) ||
                (ligacoes[74][63] == 1) || (ligacoes[75][63] == 1) ||
                (ligacoes[76][63] == 1) || (ligacoes[77][63] == 1) ||
                (ligacoes[78][63] == 1) || (ligacoes[79][63] == 1) ||
                (ligacoes[79][63] == 1) || (ligacoes[80][63] == 1) ||
                (ligacoes[81][63] == 1) || (ligacoes[82][63] == 1) ||
                (ligacoes[83][63] == 1))
            {
                entradaTrans2 = false;
            }
        ...
        if (blocoTrans == true)
        {
            ...
            if ((entradaTrans1 == false) && (entradaTrans2 == false))
            {
                                    ...
                                    if (ligacoes[aux][64] == 1)
                                    {
                                        ...
                                        while (k < rc + 1)
                                        {
                                            if (ligacoes[k][65] == 1)
                                            {
                                                ...
                                                matrixValores[j][k] = matrixValores[i][63];
                                                matrixValores[k][j] = matrixValores[i][63];
                                            }
                                            k = k + 1;
                                        }
                                    }
        ...
        if (entradaEx1 == true)
        {
            ...
            // Caigualso facil em que e um input imediato
            if ((ligacoes[1][90] == 1) || (ligacoes[2][90] == 1) ||
                (ligacoes[3][90] == 1) || (ligacoes[4][90] == 1) ||
                (ligacoes[5][90] == 1) || (ligacoes[14][90] == 1) ||
                (ligacoes[25][90] == 1) || (ligacoes[30][90] == 1) ||
                (ligacoes[35][90] == 1) || (ligacoes[36][90] == 1) ||
                (ligacoes[37][90] == 1) ||
                (ligacoes[66][90] == 1) || (ligacoes[67][90] == 1) ||
                (ligacoes[68][90] == 1) || (ligacoes[69][90] == 1) ||
                (ligacoes[70][90] == 1) || (ligacoes[71][90] == 1) ||
                (ligacoes[72][90] == 1) || (ligacoes[73][90] == 1) ||
                (ligacoes[74][90] == 1) || (ligacoes[75][90] == 1) ||
                (ligacoes[76][90] == 1) || (ligacoes[77][90] == 1) ||
                (ligacoes[78][90] == 1) || (ligacoes[79][90] == 1) ||
                (ligacoes[79][90] == 1) || (ligacoes[80][90] == 1) ||
                (ligacoes[81][90] == 1) || (ligacoes[82][90] == 1) ||
                (ligacoes[83][90] == 1))
            {
                entradaTrans1 = false;
            }
                ...
                while (i < rc + 1)
                {
                    if (ligacoes[i][90] == 1)
                    {
                        ...
                        while (j < rc + 1)
                        {
                            if (ligacoes[j][91] == 1)
                            {
                                matrixValores[i][j] = matrixValores[i][90];
                                matrixValores[j][i] = matrixValores[i][90];
                                ligacoes[i][j] = 1;
                                ligacoes[j][i] = 1;
                            }
                            j = j + 1;
                        ...
                        while (aux < rc + 1)
                        {
                            if (ligacoes[aux][92] == 1)
                            {
                                matrixValores[i][aux] = matrixValores[i][90];
                                matrixValores[aux][i] = matrixValores[i][90];
                                ligacoes[i][aux] = 1;
                                ligacoes[aux][i] = 1;
                            }
                            aux = aux + 1;
